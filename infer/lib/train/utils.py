...
def get_logger(model_dir, filename="train.log"):
    ...
    logger_name = os.path.basename(model_dir) if model_dir else "rvc_train"
    logger = logging.getLogger(logger_name)
    logger.setLevel(logging.DEBUG)
    log_file_path = os.path.join(model_dir, filename)  
    ...
    if not file_handler_exists:
        ...
        h.setLevel(logging.DEBUG) # Файловый обработчик может иметь свой уровень
